...
<main>
    ...
    <section id="hero" class="mt-[84px] mb-8 bg-[#baffae]">
        <h1 class="text-[36px] font-bold mb-2">
            <p class="text-left text-center">Tambah Data Keluarga</p>
        </h1>
    </section>
            ...
            <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
                ...
                <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform" x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100" x-transition:leave="transition ease-in duration-200 transform" x-transition:leave-start="opacity-100 translate-y-0 sm:scale-100" x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" class="inline-block w-full max-w-xl p-8 my-20 overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl 2xl:max-w-2xl">
                    <div class="flex items-center justify-between space-x-4">
                        <h1 class="text-xl font-medium text-gray-800 ">Tambah Anggota Keluarga</h1>
                    ...
                    <form action="{{ route('tambah-anggota-keluarga') }}" method="POST" class="needs-validation">
                        @csrf
                        <input type="hidden" class="form-control" name="osm_id" value="{{ $id }}">

                        <div class="mb-3">
                            <label for="nama_lengkap" class="form-label">Nama Lengkap</label>
                            <input type="text" class="block w-full border border-gray-400 rounded px-3 py-1 mt-1" id="nama_lengkap" name="nama_lengkap" value="{{ old('nama_lengkap') }}" required>
                        </div>

                        <div class="mb-3">
                            <label for="nik" class="form-label">NIK</label>
                            <input type="number" class="block w-full border border-gray-400 rounded px-3 py-1 mt-1" id="nik" name="nik" value="{{ old('nik') }}" required>
                        </div>

                        <div class="mb-3">
                            <label for="jenis_kelamin" class="form-label">Jenis Kelamin</label>
                            <div class="form-check">
                                <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" type="radio" name="jenis_kelamin" id="laki-laki" value="laki-laki" required>
                                <label class="form-check-label" for="laki-laki">
                                    Laki-laki
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" type="radio" name="jenis_kelamin" id="perempuan" value="perempuan" required>
                        ...
                        <div class="mb-3">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="block w-full border border-gray-400 rounded px-3 py-1 mt-1" id="tempat_lahir" name="tempat_lahir" required>
                                </div>

                                <div class="col-md-6">
                                    <label for="tanggal_lahir" class="form-label">Tanggal Lahir</label>
                                    <input type="date" class="block w-full border border-gray-400 rounded px-3 py-1 mt-1" id="tanggal_lahir" name="tanggal_lahir" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="block w-full border border-gray-400 rounded px-3 py-1 mt-1" id="tingkat_pendidikan" name="tingkat_pendidikan" required>
                                <option value="Tidak / Belum Sekolah" {{ old('tingkat_pendidikan') == 'Tidak / Belum Sekolah' ? 'selected' : '' }}>Tidak / Belum Sekolah</option>
                                <option value="Belum Tamat SD / Sederajat" {{ old('tingkat_pendidikan') == 'Belum Tamat SD / Sederajat' ? 'selected' : '' }}>Belum Tamat SD / Sederajat</option>
                                <option value="Tamat SD / Sederajat" {{ old('tingkat_pendidikan') == 'Tamat SD / Sederajat' ? 'selected' : '' }}>Tamat SD / Sederajat</option>
                                <option value="SLTP / Sederajat" {{ old('tingkat_pendidikan') == 'SLTP / Sederajat' ? 'selected' : '' }}>SLTP / Sederajat</option>
                                <option value="SLTA / Sederajat" {{ old('tingkat_pendidikan') == 'SLTA / Sederajat' ? 'selected' : '' }}>SLTA / Sederajat</option>
                                <option value="Diploma I / II" {{ old('tingkat_pendidikan') == 'Diploma I / II' ? 'selected' : '' }}>Diploma I / II</option>
                                <option value="Akademi / Diploma III / Sarjana Muda" {{ old('tingkat_pendidikan') == 'Akademi / Diploma III / Sarjana Muda' ? 'selected' : '' }}>Akademi / Diploma III / Sarjana Muda</option>
                                <option value="Diploma IV / Strata I" {{ old('tingkat_pendidikan') == 'Diploma IV / Strata I' ? 'selected' : '' }}>Diploma IV / Strata I</option>
                                <option value="Strata II" {{ old('tingkat_pendidikan') == 'Strata II' ? 'selected' : '' }}>Strata II</option>
                                <option value="Strata III" {{ old('tingkat_pendidikan') == 'Strata III' ? 'selected' : '' }}>Strata III</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="block w-full border border-gray-400 rounded px-3 py-1 mt-1" id="jenis_pekerjaan" name="jenis_pekerjaan" required>
                                <option value="Belum / Tidak Bekerja" {{ old('jenis_pekerjaan') == 'Belum / Tidak Bekerja' ? 'selected' : '' }}>Belum / Tidak Bekerja</option>
                                <option value="Mengurus Rumah Tangga" {{ old('jenis_pekerjaan') == 'Mengurus Rumah Tangga' ? 'selected' : '' }}>Mengurus Rumah Tangga</option>
                                <option value="Pelajar / Mahasiswa" {{ old('jenis_pekerjaan') == 'Pelajar / Mahasiswa' ? 'selected' : '' }}>Pelajar / Mahasiswa</option>
                                <option value="Pensiunan" {{ old('jenis_pekerjaan') == 'Pensiunan' ? 'selected' : '' }}>Pensiunan</option>
                                <option value="Pegawai Negeri Sipil (PNS)" {{ old('jenis_pekerjaan') == 'Pegawai Negeri Sipil (PNS)' ? 'selected' : '' }}>Pegawai Negeri Sipil (PNS)</option>
                                <option value="Tentara Nasional Indonesia (TNI)" {{ old('jenis_pekerjaan') == 'Tentara Nasional Indonesia (TNI)' ? 'selected' : '' }}>Tentara Nasional Indonesia (TNI)</option>
                                <option value="Kepolisian RI (POLRI)" {{ old('jenis_pekerjaan') == 'Kepolisian RI (POLRI)' ? 'selected' : '' }}>Kepolisian RI (POLRI)</option>
                                <option value="Perdagangan" {{ old('jenis_pekerjaan') == 'Perdagangan' ? 'selected' : '' }}>Perdagangan</option>
                                <option value="Petani / Pekebun" {{ old('jenis_pekerjaan') == 'Petani / Pekebun' ? 'selected' : '' }}>Petani / Pekebun</option>
                                <option value="Peternak" {{ old('jenis_pekerjaan') == 'Peternak' ? 'selected' : '' }}>Peternak</option>
                                <option value="Nelayan/Perikanan" {{ old('jenis_pekerjaan') == 'Nelayan/Perikanan' ? 'selected' : '' }}>Nelayan/Perikanan</option>
                                <option value="Industri" {{ old('jenis_pekerjaan') == 'Industri' ? 'selected' : '' }}>Industri</option>
                                <option value="Konstruksi" {{ old('jenis_pekerjaan') == 'Konstruksi' ? 'selected' : '' }}>Konstruksi</option>
                                <option value="Transportasi" {{ old('jenis_pekerjaan') == 'Transportasi' ? 'selected' : '' }}>Transportasi</option>
                                <option value="Karyawan Swasta" {{ old('jenis_pekerjaan') == 'Karyawan Swasta' ? 'selected' : '' }}>Karyawan Swasta</option>
                                <option value="Karyawan BUMN" {{ old('jenis_pekerjaan') == 'Karyawan BUMN' ? 'selected' : '' }}>Karyawan BUMN</option>
                                <option value="Karyawan BUMD" {{ old('jenis_pekerjaan') == 'Karyawan BUMD' ? 'selected' : '' }}>Karyawan BUMD</option>
                                <option value="Karyawan Honorer" {{ old('jenis_pekerjaan') == 'Karyawan Honorer' ? 'selected' : '' }}>Karyawan Honorer</option>
                                <option value="Buruh Harian Lepas" {{ old('jenis_pekerjaan') == 'Buruh Harian Lepas' ? 'selected' : '' }}>Buruh Harian Lepas</option>
                                <option value="Buruh Tani / Perkebunan" {{ old('jenis_pekerjaan') == 'Buruh Tani / Perkebunan' ? 'selected' : '' }}>Buruh Tani / Perkebunan</option>
                                <option value="Buruh Nelayan/Perikanan" {{ old('jenis_pekerjaan') == 'Buruh Nelayan/Perikanan' ? 'selected' : '' }}>Buruh Nelayan/Perikanan</option>
                                <option value="Buruh Peternakan" {{ old('jenis_pekerjaan') == 'Buruh Peternakan' ? 'selected' : '' }}>Buruh Peternakan</option>
                                <option value="Pembantu Rumah Tangga" {{ old('jenis_pekerjaan') == 'Pembantu Rumah Tangga' ? 'selected' : '' }}>Pembantu Rumah Tangga</option>
                                <option value="Tukang Cukur" {{ old('jenis_pekerjaan') == 'Tukang Cukur' ? 'selected' : '' }}>Tukang Cukur</option>
                                <option value="Tukang Listrik" {{ old('jenis_pekerjaan') == 'Tukang Listrik' ? 'selected' : '' }}>Tukang Listrik</option>
                                <option value="Tukang Batu" {{ old('jenis_pekerjaan') == 'Tukang Batu' ? 'selected' : '' }}>Tukang Batu</option>
                                <option value="Tukang Kayu" {{ old('jenis_pekerjaan') == 'Tukang Kayu' ? 'selected' : '' }}>Tukang Kayu</option>
                                <option value="Tukang Sol Sepatu" {{ old('jenis_pekerjaan') == 'Tukang Sol Sepatu' ? 'selected' : '' }}>Tukang Sol Sepatu</option>
                                <option value="Tukang Las/Pandai Besi" {{ old('jenis_pekerjaan') == 'Tukang Las/Pandai Besi' ? 'selected' : '' }}>Tukang Las/Pandai Besi</option>
                                <option value="Tukang Jahit" {{ old('jenis_pekerjaan') == 'Tukang Jahit' ? 'selected' : '' }}>Tukang Jahit</option>
                                <option value="Tukang Gigi" {{ old('jenis_pekerjaan') == 'Tukang Gigi' ? 'selected' : '' }}>Tukang Gigi</option>
                                <option value="Penata Rias" {{ old('jenis_pekerjaan') == 'Penata Rias' ? 'selected' : '' }}>Penata Rias</option>
                                <option value="Penata Busana" {{ old('jenis_pekerjaan') == 'Penata Busana' ? 'selected' : '' }}>Penata Busana</option>
                                <option value="Mekanik" {{ old('jenis_pekerjaan') == 'Mekanik' ? 'selected' : '' }}>Mekanik</option>
                                <option value="Seniman" {{ old('jenis_pekerjaan') == 'Seniman' ? 'selected' : '' }}>Seniman</option>
                                <option value="Tabib" {{ old('jenis_pekerjaan') == 'Tabib' ? 'selected' : '' }}>Tabib</option>
                                <option value="Paraji" {{ old('jenis_pekerjaan') == 'Paraji' ? 'selected' : '' }}>Paraji</option>
                                <option value="Perancang Busana" {{ old('jenis_pekerjaan') == 'Perancang Busana' ? 'selected' : '' }}>Perancang Busana</option>
                                <option value="Penterjemah" {{ old('jenis_pekerjaan') == 'Penterjemah' ? 'selected' : '' }}>Penterjemah</option>
                                <option value="Imam Masjid" {{ old('jenis_pekerjaan') == 'Imam Masjid' ? 'selected' : '' }}>Imam Masjid</option>
                                <option value="Pendeta" {{ old('jenis_pekerjaan') == 'Pendeta' ? 'selected' : '' }}>Pendeta</option>
                                <option value="Pator" {{ old('jenis_pekerjaan') == 'Pator' ? 'selected' : '' }}>Pator</option>
                                <option value="Wartawan" {{ old('jenis_pekerjaan') == 'Wartawan' ? 'selected' : '' }}>Wartawan</option>
                                <option value="Ustadz / Mubaligh" {{ old('jenis_pekerjaan') == 'Ustadz / Mubaligh' ? 'selected' : '' }}>Ustadz / Mubaligh</option>
                                <option value="Juru Masak" {{ old('jenis_pekerjaan') == 'Juru Masak' ? 'selected' : '' }}>Juru Masak</option>
                                <option value="Promotor Acara" {{ old('jenis_pekerjaan') == 'Promotor Acara' ? 'selected' : '' }}>Promotor Acara</option>
                                <option value="Anggota DPR-RI" {{ old('jenis_pekerjaan') == 'Anggota DPR-RI' ? 'selected' : '' }}>Anggota DPR-RI</option>
                                <option value="Anggota DPD" {{ old('jenis_pekerjaan') == 'Anggota DPD' ? 'selected' : '' }}>Anggota DPD</option>
                                <option value="Anggota BPK" {{ old('jenis_pekerjaan') == 'Anggota BPK' ? 'selected' : '' }}>Anggota BPK</option>
                                <option value="Presiden" {{ old('jenis_pekerjaan') == 'Presiden' ? 'selected' : '' }}>Presiden</option>
                                <option value="Wakil Presiden" {{ old('jenis_pekerjaan') == 'Wakil Presiden' ? 'selected' : '' }}>Wakil Presiden</option>
                                <option value="Anggota Mahkamah Konstitusi" {{ old('jenis_pekerjaan') == 'Anggota Mahkamah Konstitusi' ? 'selected' : '' }}>Anggota Mahkamah Konstitusi</option>
                                <option value="Anggota Kabinet Kementrian" {{ old('jenis_pekerjaan') == 'Anggota Kabinet Kementrian' ? 'selected' : '' }}>Anggota Kabinet Kementrian</option>
                                <option value="Duta Besar" {{ old('jenis_pekerjaan') == 'Duta Besar' ? 'selected' : '' }}>Duta Besar</option>
                                <option value="Gubernur" {{ old('jenis_pekerjaan') == 'Gubernur' ? 'selected' : '' }}>Gubernur</option>
                                <option value="Wakil Gubernur" {{ old('jenis_pekerjaan') == 'Wakil Gubernur' ? 'selected' : '' }}>Wakil Gubernur</option>
                                <option value="Bupati" {{ old('jenis_pekerjaan') == 'Bupati' ? 'selected' : '' }}>Bupati</option>
                                <option value="Wakil Bupati" {{ old('jenis_pekerjaan') == 'Wakil Bupati' ? 'selected' : '' }}>Wakil Bupati</option>
                                <option value="Walikota" {{ old('jenis_pekerjaan') == 'Walikota' ? 'selected' : '' }}>Walikota</option>
                                <option value="Wakil Walikota" {{ old('jenis_pekerjaan') == 'Wakil Walikota' ? 'selected' : '' }}>Wakil Walikota</option>
                                <option value="Anggota DPRP Prop." {{ old('jenis_pekerjaan') == 'Anggota DPRP Prop.' ? 'selected' : '' }}>Anggota DPRP Prop.</option>
                                <option value="Anggota DPRP Kab." {{ old('jenis_pekerjaan') == 'Anggota DPRP Kab.' ? 'selected' : '' }}>Anggota DPRP Kab.</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="block w-full border border-gray-400 rounded px-3 py-1 mt-1" id="tanggal_perkawinan" name="tanggal_perkawinan" value="{{ old('tanggal_perkawinan') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="block w-full border border-gray-400 rounded px-3 py-1 mt-1" id="no_paspor" name="no_paspor" value="{{ old('no_paspor') }}">
                                </div>

                                <div class="col-md-6">
                                    <label for="no_kitab" class="form-label">No. KITAP</label>
                                    <input type="number" class="block w-full border border-gray-400 rounded px-3 py-1 mt-1" id="no_kitab" name="no_kitab" value="{{ old('no_kitab') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="block w-full border border-gray-400 rounded px-3 py-1 mt-1" id="nama_orangtua_ayah" name="nama_orangtua_ayah" value="{{ old('nama_orangtua_ayah') }}" required>
                                </div>

                                <div class="col-md-6">
                                    <label for="nama_orangtua_ibu" class="form-label">Nama Orang Tua Ibu</label>
                                    <input type="text" class="block w-full border border-gray-400 rounded px-3 py-1 mt-1" id="nama_orangtua_ibu" name="nama_orangtua_ibu" value="{{ old('nama_orangtua_ibu') }}" required>
                                </div>
                            </div>
                        </div>
            ...
            <div id="myTabContent">
                <div class="bg-white p-4 rounded-lg hidden" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <div class="mb-3">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select id="desa" class="block w-full border border-gray-400 rounded px-3 py-1 mt-1" name="desa_id" required>
                                        <option value="">--Pilih Desa--</option>
                                        @foreach ($desas as $desa)
                                        <option value="{{ $desa->id }}" {{ old('desa_id', optional($kartuKeluarga)->desa_id) == $desa->id ? 'selected' : '' }}> {{ $desa->nama_desa }} </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <label for="kecamatan" class="form-label">Kecamatan</label>
                                    <select id="kecamatan" class="block w-full border border-gray-400 rounded px-3 py-1 mt-1" name="kecamatan_id" required>
                                        <option value="">--Pilih Kecamatan--</option>
                                        @foreach ($kecamatans as $kecamatan)
                                        <option value="{{ $kecamatan->id }}" {{ old('kecamatan_id', optional($kartuKeluarga)->kecamatan_id) == $kecamatan->id ? 'selected' : '' }}> {{ $kecamatan->nama_kecamatan }} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="mb-3">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select id="kabupaten" class="block w-full border border-gray-400 rounded px-3 py-1 mt-1" name="kabupaten_id" required>
                                        <option value="">--Pilih Kabupaten--</option>
                                        @foreach ($kabupatens as $kabupaten)
                                        <option value="{{ $kabupaten->id }}" {{ old('kabupaten_id', optional($kartuKeluarga)->kabupaten_id) == $kabupaten->id ? 'selected' : '' }}> {{ $kabupaten->nama_kabupaten }} </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <label for="provinsi" class="form-label">Provinsi</label>
                                    <select id="provinsi" class="block w-full border border-gray-400 rounded px-3 py-1 mt-1" name="provinsi_id" required>
                                        <option value="">--Pilih Provinsi--</option>
                                        @foreach ($provinsis as $provinsi)
                                        <option value="{{ $provinsi->id }}" {{ old('provinsi_id', optional($kartuKeluarga)->provinsi_id) == $provinsi->id ? 'selected' : '' }}> {{ $provinsi->nama_provinsi }} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <form action="{{ route('data-keluarga.store') }}" method="POST" class="needs-validation" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="kepala_keluarga" class="form-label">Nama Kepala Keluarga</label>
                            <input type="text" class="block w-full border border-gray-400 rounded px-3 py-1 mt-1" name="kepala_keluarga" value="{{ isset($kepalaKeluarga->nama_lengkap) ? $kepalaKeluarga->nama_lengkap : '' }}" disabled>
                        </div>
